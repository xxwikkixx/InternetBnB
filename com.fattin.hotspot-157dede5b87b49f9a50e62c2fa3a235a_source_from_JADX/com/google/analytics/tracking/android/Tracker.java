...
public class Tracker {
    ...
    public void setAppScreen(String appScreen) {
        ...
        this.mModel.set(ModelFields.DESCRIPTION, appScreen);
    }
    ...
    public void sendView() {
        assertTrackerOpen();
        if (TextUtils.isEmpty(this.mModel.get(ModelFields.DESCRIPTION))) {
    ...
    public void sendException(String threadName, Throwable exception, boolean fatal) {
        ...
        if (this.mExceptionParser != null) {
            ...
            try {
                ...
                Log.m10w("trackException: couldn't serialize, sending \"Unknown Exception\"");
    ...
    public void setCustomDimension(int index, String value) {
        if (index < 1) {
            Log.m10w("index must be > 0, ignoring setCustomDimension call for " + index + ", " + value);
        } else {
    ...
    public void setCustomMetric(int index, Long value) {
        if (index < 1) {
            Log.m10w("index must be > 0, ignoring setCustomMetric call for " + index + ", " + value);
            return;
        }
