...
class MetaModelInitializer {
    ...
    static class 1 implements Formatter {
        1() {
        }
    ...
    static class 2 implements Formatter {
    ...
    static {
        BOOLEAN_FORMATTER = new 1();
        UP_TO_TWO_DIGIT_FLOAT_FORMATTER = new 2();
    }
    ...
    public static void set(MetaModel m) {
        ...
        m.addField(ModelFields.TITLE, "dt", null, null);
        ...
        m.addField(ModelFields.DESCRIPTION, "cd", null, null);
