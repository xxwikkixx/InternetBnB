...
public class DNSInput {
    ...
    public int readU16() throws WireParseException {
        ...
        int i = this.pos;
        this.pos = i + 1;
        int b1 = bArr[i] & KEYRecord.PROTOCOL_ANY;
        bArr = this.array;
        i = this.pos;
        this.pos = i + 1;
        return (b1 << 8) + (bArr[i] & KEYRecord.PROTOCOL_ANY);
    }
    ...
    public long readU32() throws WireParseException {
        ...
        i = this.pos;
        this.pos = i + 1;
        int b2 = bArr[i] & KEYRecord.PROTOCOL_ANY;
        bArr = this.array;
        i = this.pos;
        this.pos = i + 1;
        int b3 = bArr[i] & KEYRecord.PROTOCOL_ANY;
        bArr = this.array;
        i = this.pos;
        this.pos = i + 1;
        return (((((long) b1) << 24) + ((long) (b2 << 16))) + ((long) (b3 << 8))) + ((long) (bArr[i] & KEYRecord.PROTOCOL_ANY));
    }
