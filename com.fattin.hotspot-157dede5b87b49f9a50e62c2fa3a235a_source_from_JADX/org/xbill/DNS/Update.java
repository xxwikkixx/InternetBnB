...
public class Update extends Message {
    ...
    public void present(Name name) {
        newPrereq(Record.newRecord(name, KEYRecord.PROTOCOL_ANY, KEYRecord.PROTOCOL_ANY, 0));
    }

    public void present(Name name, int type) {
        newPrereq(Record.newRecord(name, type, KEYRecord.PROTOCOL_ANY, 0));
    }
    ...
    public void absent(Name name) {
        newPrereq(Record.newRecord(name, KEYRecord.PROTOCOL_ANY, CERTRecord.OID, 0));
    }

    public void absent(Name name, int type) {
        newPrereq(Record.newRecord(name, type, CERTRecord.OID, 0));
    }
    ...
    public void delete(Name name) {
        newUpdate(Record.newRecord(name, KEYRecord.PROTOCOL_ANY, KEYRecord.PROTOCOL_ANY, 0));
    }

    public void delete(Name name, int type) {
        newUpdate(Record.newRecord(name, type, KEYRecord.PROTOCOL_ANY, 0));
    }

    public void delete(Name name, int type, String record) throws IOException {
        newUpdate(Record.fromString(name, type, (int) CERTRecord.OID, 0, record, this.origin));
    }

    public void delete(Name name, int type, Tokenizer tokenizer) throws IOException {
        newUpdate(Record.fromString(name, type, (int) CERTRecord.OID, 0, tokenizer, this.origin));
    }

    public void delete(Record record) {
        newUpdate(record.withDClass(CERTRecord.OID, 0));
    }
