...
public class DNSOutput {
    ...
    public void writeU8(int val) {
        ...
        int i = this.pos;
        this.pos = i + 1;
        bArr[i] = (byte) (val & KEYRecord.PROTOCOL_ANY);
    }
    ...
    public void writeU16(int val) {
        ...
        int i = this.pos;
        this.pos = i + 1;
        bArr[i] = (byte) ((val >>> 8) & KEYRecord.PROTOCOL_ANY);
        bArr = this.array;
        i = this.pos;
        this.pos = i + 1;
        bArr[i] = (byte) (val & KEYRecord.PROTOCOL_ANY);
    ...
    public void writeU16At(int val, int where) {
        ...
        int i = where + 1;
        this.array[where] = (byte) ((val >>> 8) & KEYRecord.PROTOCOL_ANY);
        where = i + 1;
        this.array[i] = (byte) (val & KEYRecord.PROTOCOL_ANY);
    }
    ...
    public void writeCountedString(byte[] s) {
        if (s.length > KEYRecord.PROTOCOL_ANY) {
        ...
        int i = this.pos;
        this.pos = i + 1;
        bArr[i] = (byte) (s.length & KEYRecord.PROTOCOL_ANY);
